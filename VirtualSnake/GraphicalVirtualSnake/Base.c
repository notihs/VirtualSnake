...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR lpCmdLine, int nCmdShow) {
	...
	wcApp.lpfnWndProc = HandleEvents;	// Endereço da função de processamento da janela 	// ("HandleEvents" foi declarada no início e                 // encontra-se mais abaixo)
	...
	hWnd = CreateWindow(
		...
		TEXT("VirtualSnake"),// Texto que figura na barra do título
